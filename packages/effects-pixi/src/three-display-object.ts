 ...
 * ```
 */
export class ThreeDisplayObject extends Container {
  ...
  constructor (
    app: Application,
    options: PixiDisplayObjectOptions,
  ) {
    super();

...
describe('Player downgrade', () => {
  ...
  it('mock-pass', async () => {
    ...
    try {
      ...
      expect(comp.compositionSourceManager.renderLevel).to.equal(spec.RenderLevel.S);
      playerFunc();
    } catch (e) {
      catchFunc();
    }
  ...
  it('not downgrade', async () => {
    ...
    try {
      ...
      expect(comp.compositionSourceManager.renderLevel).to.equal(spec.RenderLevel.A);
      playerFunc();
    } catch (e) {
      catchFunc();
    }

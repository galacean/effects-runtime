...
export class RegionAttachment extends Attachment implements HasTextureRegion {
  ...
  offset = ArrayUtils.newFloatArray(8);

  uvs = ArrayUtils.newFloatArray(8);
  ...
  computeWorldVertices (slot: Slot, worldVertices: Array<number>, offset: number, stride: number) {
  ...
  copy (): Attachment {
    ...
    ArrayUtils.arrayCopy(this.uvs, 0, copy.uvs, 0, 8);
    ArrayUtils.arrayCopy(this.offset, 0, copy.offset, 0, 8);

import { Player, RendererComponent, Texture, glContext, setBlendMode, spec } from '@galacean/effects';

const json = 'https://mdn.alipayobjects.com/mars/afts/file/A*bsBVSa4VNIIAAAAAQDAAAAgAelB4AQ';
...
// void main(){
//     vec4 texColor=texture2D(_MainTex,uv).rgba;
//     vec4 color=texColor*_MainColor.rgba;
//     color.rgb *= color.a;
...
(async () => {
  ...
  jsonValue.materials[0].colors['_MainColor'] = { r: 0, g: 0, b: 1, a: 1 };
    ...
    for (const component of rendererComponents) {
      ...
      for (const material of materials) {
        ...
        const whiteTexture = {
          width: 1,
          height: 1,
          data: new Uint8Array([111, 111, 111, 255]),
        };
        ...
        // 将纹理分配给material的_Spectrum属性
        material.setTexture('_Spectrum', texture);
      }
    }
  }
})();

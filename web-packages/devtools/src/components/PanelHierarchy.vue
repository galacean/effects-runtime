...
import { menuGui, treeData, treeGui, currentNode } from '../utils';
import { ref } from 'vue'
...
<template>
  <AGUIPanel h="full" w="full">
    <AGUITabs :list="tabList">
      <AGUITabPanel>
        <AGUITree class="w-full h-full" :data="treeData" v-bind="treeGui.panel" id="myDiv" v-model:currentNode="currentNode"/>
      </AGUITabPanel>
    </AGUITabs>
  </AGUIPanel>

...
const properties = `
u_LayerTilingOffset("LayerTilingOffset", Vector) = (1, 1, 0, 0)
u_BgTex("BgTex", 2D) = "white" {}
u_DeskTex("DeskTex", 2D) = "white" {}
u_CubeDepth("CubeDepth", Float) = 1
u_UVDepth("UVDepth", Float) = 0.5
`;

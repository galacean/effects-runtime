...
describe('plugin-gui/GUI clipping and scrolling', () => {
  ...
  it('passes wheel input to an outer container at an inner boundary', () => {
    ...
    wheel.factor = 1;
    player.engine.getServer(GUIServer).windowRoot.pushInput(wheel);
  ...
  it('drags with a deadzone and continues with inertial scrolling', () => {
    ...
    player.engine.getServer(GUIServer).windowRoot.pushInput(down);
    ...
    player.engine.getServer(GUIServer).windowRoot.pushInput(up);
    scroll.update(100);
  ...
  it('emits guiFocusChanged from the root when the focus owner changes', () => {
    ...
    player.engine.getServer(GUIServer).windowRoot.on('guiFocusChanged', focusChanged);
    control.grabFocus();
    control.grabFocus();
    control.releaseFocus();
    player.engine.getServer(GUIServer).windowRoot.off('guiFocusChanged', focusChanged);
    control.grabFocus();
